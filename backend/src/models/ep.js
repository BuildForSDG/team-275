...
const workExperience = new Schema({
  epId: { type: Schema.Types.ObjectId, ref: 'EducationProvider', required: true },
  company: { type: String, required: true },
  position: { type: String, required: true },
  started: { type: Date, required: true },
  leftOn: { type: Date }
});
const EducationProvider = mongoose.model('EducationProvider', eduProviderSchema);
const Education = mongoose.model('Education', educationSchema);
const WorkExperience = mongoose.model('WorkExperience', workExperience);

export { EducationProvider, Education, WorkExperience };
